...
FolderName <- paste("C:/Users/meule01a/OneDrive - Sanquin/A4 Project SanguinStats (OD)/07 Resultaten/figures/", currentDate,"/AUPRadj_SanguinStatsMeeting",sep="")
dir.create(FolderName)
...
countries <- c("Netherlands","Finland","Australia (Own cut off)", "Australia (EU cut off)", "Belgium")
...
FolderName <- paste("C:/Users/meule01a/OneDrive - Sanquin/A4 Project SanguinStats (OD)/07 Resultaten/figures/", currentDate,"/AUPR_SanguinStatsMeeting",sep="")
dir.create(FolderName)
