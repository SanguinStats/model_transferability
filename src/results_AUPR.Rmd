...
data_sizes <- bind_rows(datalist) %>%
  ...
  mutate(deferral_rate = Deferred.last.donations / Donors,
         modelcountry = case_when(modelcountry=='BE' ~ 'Belgium',
                             ...
                             modelcountry=='SA' ~ 'South Africa (12.5/13.5 cut off)',
                             modelcountry=='SA2' ~ 'South Africa (12/13 cut off)',
                             modelcountry=='AU' ~ 'Australia (12/13 cut off)', 
                             modelcountry=='AU2' ~ 'Australia (12.5/13.5 cut off)'),
