...
path <- "C:/Users/meule01a/OneDrive - Sanquin/A4 Project SanguinStats (OD)/07 Resultaten/20230301 SanguinStats results overview/results/"
...
FolderName <- paste("C:/Users/meule01a/OneDrive - Sanquin/A4 Project SanguinStats (OD)/07 Resultaten/20230301 SanguinStats results overview/figures/", currentDate,sep="")
dir.create(FolderName)

countries <- c("Netherlands","Finland","South Africa","Australia", "Belgium")
countries <- c("Netherlands","Finland","South Africa","Australia") #selected only finland and NL because we only ran models on these data
...
FileName <- paste(FolderName, "/Modelperformance_AUPRadj_Data", countries[i] ,".png",sep="")
...
FileName <- paste(FolderName, "/Modelperformance_AUPR_Data", countries[i] ,".png",sep="")
ggsave(FileName, width = 7, height = 4)
}
```
