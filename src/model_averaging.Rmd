...
"Australia", "2don", "australia-2023-02-24", "svm-and-rf-models_Australia_2don.zip",
"Australia", "5don", "australia-2023-02-24", "svm-and-rf-models_Australia_5don.zip",
"Australia", "5don4hb", "australia-2023-02-24", "svm-and-rf-models_Australia_5don4hb.zip",
...
"Australia2", "2don", "australia-2023-03-28-unified_threshold", "svm-and-rf-models_Australia_2don.zip",
"Australia2", "5don", "australia-2023-03-28-unified_threshold", "svm-and-rf-models_Australia_5don.zip",
"Australia2", "5don4hb", "australia-2023-03-28-unified_threshold", "svm-and-rf-models_Australia_5don4hb.zip",
...
df_with_pred2 <- recomputed_datas %>% select(-sex) %>% unnest(df)
df_with_pred2 <- df_with_pred2 %>% select(-c(validate, fit))
...
```{r}
number_of_deferrals <- df_with_pred2 %>% 
...
g <- cooccurrence2 %>%
  ...
  #filter(Var1 != "Average" & Var2 != "Average") %>%
  mutate(Var2 = fct_rev(Var2)) %>%
  ggplot(aes(x=Var1, y=Var2, fill=percentage)) + 
  geom_raster(na.rm=TRUE) +
  geom_text(aes(label=n), color="white", size=3, na.rm=TRUE) +
  labs(x="Model country", y="Model country", title="Number of observations both countries consider as true positives", 
  ...
  theme(legend.position="bottom",
        ...
        legend.text = element_text(angle = 45, vjust=1, hjust=1))
g
ggsave(sprintf("%s/cooccurrences-of-true-positives.pdf", fig_path), g)
```
