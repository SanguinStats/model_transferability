...
auprplot <- annotate_figure(auprplot, right = text_grob("Model evaluated in", rot = -90, size = 10, x = 0.7, vjust=1))
...
aurocplot <- annotate_figure(aurocplot, right = text_grob("Model evaluated in", rot = -90, size = 10, x = 0.7, vjust=1))
...
p <- annotate_figure(p, right = text_grob("Model evaluated in", rot = -90, size = 10, x = 0.7, vjust=1))
...
plt <- annotate_figure(plt, right = text_grob("Model evaluated in", rot = -90, size = 10, x = -9.75, vjust=1))
